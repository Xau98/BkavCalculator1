...
public class BkavCalculatorEditText extends FormattedNumberEditText {
    private static final String TAG = BkavCalculatorEditText.class.getSimpleName();
    ...
    public BkavCalculatorEditText(Context context) {
        super(context);
        setUp(context, null);
    }

    public BkavCalculatorEditText(Context context, AttributeSet attr) {
        super(context, attr);
        setUp(context, attr);
    }
